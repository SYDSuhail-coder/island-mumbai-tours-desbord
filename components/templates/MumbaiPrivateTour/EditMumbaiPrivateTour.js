...
const EditMumbaiPrivateTour = ({ slug }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`/api/upadete-private-page/${slug}`, {
        method: "PUT",
        body: data,
      });
      ...
      <div className="pi-root">
        <div className="pi-card">
          ...
          <div className="pi-header">
            ...
            <h1 className="pi-title">Edit Private Tour</h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="pi-actions">
              <button type="button" className="pi-cancel" onClick={() => router.push("/listMumbaiPrivateTour")}>
                ← Cancel
              </button>
